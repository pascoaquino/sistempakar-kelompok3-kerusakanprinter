...
import com.example.pakarprinter.API.Server;
import com.example.pakarprinter.App.AppController;
...
public class diagnosa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(diagnosa.this, ""+id, Toast.LENGTH_SHORT).show();
        ...
        iya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (y.equals("P")){
                    Intent intent = new Intent(diagnosa.this, solusi.class);
                    intent.putExtra("id",Y);
                    startActivity(intent);
                    finish();
                }
                else if(y.equals("G")){
                    Intent intent = new Intent(diagnosa.this, diagnosa.class);
                    intent.putExtra("id",Y);
                    startActivity(intent);
                    finish();
                }
        ...
        tidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (t.equals("P")){
                    ...
                    Toast.makeText(diagnosa.this, "Tidak SAkit kakak", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(diagnosa.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
